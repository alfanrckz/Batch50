    ...
    for(let i=dataBlog.length-1; i>=0; i--) {
        ...
        `
            <div class="blog-list-item">
                ...
                <a href="../html/blog-detail.html" target="_blank">
...
function renderTechnologyImages(blogObject) {
    ...
    if (blogObject.isUsingNodeJs) {
        renderImages += `<img src="../images/icon/node_js_icon.svg" alt="node-js">\n`;
    }
    if (blogObject.isUsingReactJs) {
        renderImages += `<img src="../images/icon/react_js_icon.svg" alt="node-js">\n`;
    }
    if (blogObject.isUsingNextJs) {
        renderImages += `<img src="../images/icon/next_js_icon.svg" alt="next-js">\n`;
    }
    if (blogObject.isUsingTypescript) {
        renderImages += `<img src="../images/icon/typescript_icon.svg" alt="typescript"></img>\n`;
    }
